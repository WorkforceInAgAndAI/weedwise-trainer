...
const k5Games: GameDef[] = [
 ...
 { id: 'habitat-mapping', name: 'Habitat Mapping', Icon: Map, category: 'Habitats', description: 'Place weeds in the right habitat on the map.', howToPlay: 'Sort weeds into the correct habitat areas — cropland, roadside, wetland, or pasture. Review any mistakes after each round.', component: HabitatMapping },
...
const highGames: GameDef[] = [
 ...
 { id: 'hs-habitat', name: 'Habitat Mapping', Icon: Map, category: 'Habitats', description: 'Map weeds to habitat regions with country-level detail.', howToPlay: 'Place weeds into the correct habitat zones. Review any incorrect placements after each round.', component: HSHabitatMapping },
