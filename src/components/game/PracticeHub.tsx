...
const newK5Games: GameDef[] = [
 ...
 { id: 'fun-fact-detective', name: 'Fun Fact Detective', Icon: Search, category: 'Weed ID', description: 'Match each weed photo to its Fun Fact clue card from the 14 Weeds You Can Spot module!', howToPlay: 'Tap a clue card and then tap the weed photo you think it matches. Use the fun-fact hint (and the spot-it clue) to solve every case in the round.', component: FunFactDetective },
    { id: 'sense-detective', name: 'Weed Scout Report', Icon: Eye, category: 'Safety', description: 'A farmer radios in a mystery weed in their crop field. Ask smart questions, gather clues, and name the invader!', howToPlay: 'You have 4 questions. Ask about the location, quantity, growth stage, leaves, height, flowers, or roots. Use the clues in your Scout Notebook to pick the right weed from the lineup. Never touch a weed unless a trusted adult says it is safe.', component: SenseDetective },
];
