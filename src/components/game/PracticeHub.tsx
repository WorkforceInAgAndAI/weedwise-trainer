...
const newK5Games: GameDef[] = [
 ...
 { id: 'sense-detective', name: 'Sense Detective', Icon: Eye, category: 'Safety', description: 'Use your eyes and nose like a nature detective to spot safe and toxic weeds from a distance.', howToPlay: 'Read the sense clue, then tap the weed picture that matches. Remember: never touch a weed unless a trusted adult says it is safe.', component: SenseDetective },
];
