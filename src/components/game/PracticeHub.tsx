...
const middleGames: GameDef[] = [
 ...
 { id: 'ms-safe-toxic', name: 'Safe or Toxic?', Icon: ShieldAlert, category: 'Safety', description: 'Spot the toxic weed hiding among look-alikes.', howToPlay: 'Find the dangerous weed among similar-looking plants.', component: MSSafeVsToxic },
...
const highGames: GameDef[] = [
 ...
 { id: 'invasive-habitat', name: 'Invasive ID', Icon: AlertTriangle, category: 'Invasive Species', description: 'Identify invasive weeds, their origin, and how they arrived.', howToPlay: 'ID the weed, select its continent of origin, then choose how it was introduced.', component: InvasiveHabitatMapping },
