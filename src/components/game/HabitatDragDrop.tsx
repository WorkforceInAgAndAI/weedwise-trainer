...
const HABITATS = [
 { id: 'warm', label: 'Warm-Season / Full Sun', icon: '' },
 { id: 'cool', label: 'Cool-Season / Early Spring', icon: '' },
 { id: 'wet', label: 'Wet / Poorly Drained', icon: '' },
 { id: 'dry', label: 'Dry / Disturbed', icon: '' },
];
...
export default function HabitatDragDrop({ onComplete, onNext }: Props) {
 ...
 <div>
 <h2 className="font-display font-bold text-lg text-foreground"> Habitat Sort</h2>
