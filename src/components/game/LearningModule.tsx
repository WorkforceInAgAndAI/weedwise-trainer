        ...
        <div className="space-y-4">
          <div className="bg-muted/30 rounded-lg p-4 text-sm text-foreground space-y-2">
            ...
            {isHighSchool ? (
              ...
              <>
                <p>
                  There are many ways to manage weeds. Good farmers use a <strong>combination</strong> of methods — this
                  is called <strong>Integrated Pest Management (IPM)</strong>. No single method works perfectly alone!
                </p>
                <p className="text-muted-foreground">
