...
export default function ControlTimingGame({ weed, onComplete, onNext }: Props) {
 ...
 {/* Header */}
 <div>
 <h2 className="font-display font-bold text-lg text-foreground"> Control Strategy</h2>
 ...
 <span className="text-xl">{isBothCorrect ? '' : isStageCorrect || isMethodCorrect ? '' : ''}</span>
