...
const CATEGORIES = [
 ...
 { id: 'Annual/Winter Annual', label: 'Winter Annual', icon: '', desc: 'Germinate fall, mature spring' },
];
...
export default function LifeCycleDragDrop({ onComplete, onNext }: Props) {
 ...
 className={`p-3 rounded-xl border-2 border-border text-left transition-all min-h-[90px] bg-secondary/30 ${selected && !checked ? 'hover:border-primary/50 cursor-pointer' : 'cursor-default'}`}>
