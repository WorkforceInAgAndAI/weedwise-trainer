...
export default function WeedBank({ onBack }: { onBack: () => void }) {
  ...
  if (introStep < INTRO_SLIDES.length) {
    ...
    return (
      <div className="fixed top-[84px] inset-x-0 bottom-0 practice-game-extra-offset z-50 overflow-y-auto bg-gradient-to-b from-emerald-950 via-emerald-900 to-amber-950 p-4">
  ...
  return (
    <div className="fixed top-[84px] inset-x-0 bottom-0 practice-game-extra-offset z-50 overflow-y-auto bg-gradient-to-b from-emerald-950 via-emerald-900 to-amber-950 p-3 sm:p-6">
