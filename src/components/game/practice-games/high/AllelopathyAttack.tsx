...
const STRATEGIES = [
  { id: 'root-exudate', label: 'Root Exudates', icon: '🌿', desc: 'Release chemicals from roots into soil' },
  { id: 'leaf-leach', label: 'Leaf Leachate', icon: '🍂', desc: 'Rain washes inhibitors off your leaves into soil' },
  { id: 'decomposition', label: 'Decomposition Toxins', icon: '🧫', desc: 'Your decaying matter releases inhibitory compounds' },
  { id: 'volatile', label: 'Volatile Emissions', icon: '💨', desc: 'Release gaseous inhibitors from leaves' },
];
    ...
    <div className="fixed inset-0 bg-background z-50 overflow-y-auto">
      <div className="max-w-lg mx-auto p-4">
        ...
        <div className="bg-destructive/10 rounded-xl p-4 mb-4 border border-destructive/30">
          <p className="text-xs text-destructive font-bold mb-1">⚔️ Enemy: {s.enemy}</p>
