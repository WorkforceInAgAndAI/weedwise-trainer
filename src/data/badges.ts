...
export const BADGES: BadgeDefinition[] = [
  ...
  { id: 'master_15', name: 'Weed Warrior', description: 'Master 15 weed species', icon: '⚔️', category: 'species', requirement: { type: 'species_mastered', count: 15 } },
  ...
  { id: 'topic_warm', name: 'Sun Seeker', description: 'Master all warm-season species', icon: '☀️', category: 'topic', requirement: { type: 'topic_complete', topic: 'warm' } },
  { id: 'topic_cool', name: 'Frost Fighter', description: 'Master all cool-season species', icon: '❄️', category: 'topic', requirement: { type: 'topic_complete', topic: 'cool' } },
  ...
  { id: 'topic_dry', name: 'Dust Devil', description: 'Master all dry/disturbed species', icon: '🏜️', category: 'topic', requirement: { type: 'topic_complete', topic: 'dry' } },
