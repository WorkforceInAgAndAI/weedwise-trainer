...
export const crops: Crop[] = [
  {
    ...
    emoji: "",
    description:
      "A grass crop vulnerable to broadleaf weeds early in the season. Grass weeds compete more directly for resources.",
    baseYieldValue: 850,
    vulnerableTo: ["Dicot", "Monocot"],
    commonWeeds: ["waterhemp", "giant-ragweed", "velvetleaf", "common-lambsquarters", "giant-foxtail"],
    season: "spring",
    image: "/images/corn/crop_1.jpg",
  },
  {
    id: "soybeans",
    ...
    emoji: "",
    description:
      "A broadleaf crop where grass weeds are especially problematic. Broadleaf herbicides must be selective.",
    baseYieldValue: 620,
    vulnerableTo: ["Monocot", "Dicot"],
    commonWeeds: ["waterhemp", "palmer-amaranth", "common-ragweed", "giant-foxtail", "fall-panicum"],
    season: "spring",
    image: "/images/soybeans/crop_1.jpg",
  },
  {
    id: "wheat",
  ...
  },
  {
    ...
    season: "spring",
    image: "/images/Alfalfa/crop_1.jpg",
  },
  {
    id: "oats",
  ...
  },
  {
    ...
    type: "grass",
    emoji: "",
    description: "A cool-season grain crop. Similar competitive ability to wheat.",
    baseYieldValue: 380,
    vulnerableTo: ["Dicot"],
    commonWeeds: ["wild-oat", "common-chickweed", "wild-mustard", "henbit"],
    season: "spring",
    image: "/images/Barley/crop_1.jpg",
  },
];
