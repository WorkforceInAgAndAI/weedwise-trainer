...
export const HERBICIDE_MOA: HerbicideMOA[] = [
  // ── POST ──
  {
    ...
    brands: ['quizalofop', 'sethoxydim', 'clethodim'],
  ...
  },
  {
    ...
    brands: ['imazethapyr', 'imazamox', 'metsulfuron'],
    resistanceLevel: 'Very high',
  ...
  },
  {
    ...
    brands: ['mesotrione', 'topramezone', 'tembotrione'],
  ...
  },
  {
    ...
    brands: ['2,4-D choline', 'dicamba', 'picloram'],
    resistanceLevel: 'Moderate',
  ...
  },
  {
    ...
    brands: ['atrazine', 'atrazine + metolachlor'],
  ...
  },
  {
    ...
    brands: ['glyphosate', 'glyphosate + 2,4-D'],
    resistanceLevel: 'Very high',
  ...
  },
  {
    ...
    brands: ['glufosinate-ammonium', 'glufosinate-P'],
    resistanceLevel: 'Low',
  ...
  // ── PRE ──
  {
    ...
    brands: ['pendimethalin', 'trifluralin', 'oryzalin'],
    resistanceLevel: 'Low',
  ...
  },
  {
    ...
    brands: ['EPTC', 'triallate', 'butylate'],
    resistanceLevel: 'Low',
  ...
  },
  {
    ...
    brands: ['S-metolachlor', 'acetochlor', 'metolachlor'],
    resistanceLevel: 'Low',
  ...
  },
  {
    ...
    brands: ['flufenacet + metribuzin', 'pyroxasulfone', 'pyroxasulfone + flumioxazin'],
  ...
  },
  {
    ...
    brands: ['linuron', 'diuron', 'terbacil'],
    resistanceLevel: 'Moderate',
  ...
  },
  {
    ...
    spectrum: 'Both',
    chemistry: 'Clomazone',
    brands: ['clomazone', 'clomazone + trifluralin'],
    resistanceLevel: 'None reported',
  ...
  },
  {
    ...
    brands: ['chlorsulfuron', 'metsulfuron', 'chlorimuron + metribuzin'],
    resistanceLevel: 'Very high',
