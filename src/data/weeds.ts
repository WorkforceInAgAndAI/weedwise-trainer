...
export const weeds: Weed[] = [
  ...
  },
  {
    ...
    management:
      "PRE herbicides, early POST before boot, improved species reseeding, mechanical control (tillage) is particularly effective given the shallow root system",
  ...
  },
  {
    ...
    management:
      "Repeated POST glyphosate, mechanical removal of rhizomes, rotation. Fall applications are significantly more effective",
  ...
  },
  {
    ...
    management:
      "Fall POST herbicides, early spring control, reseeding, prescribed burning. Crop rotation is the most effective control method. Crops planted in late spring such as corn, grain sorghum, proso millet, and sunflower are much more effective for long-term management.",
  ...
  },
  {
    ...
    lookAlike: {
      ...
      species: "Tall Morningglory",
      difference:
        "Field Bindweed has two tiny, scale-like bracts located on the flower stem about 1/2 to 1 inch below the flower. (In Hedge Bindweed, the bracts are large and right at the base of the flower)",
    },
  ...
  },
  {
    ...
    management:
      "Hand pulling is most effective on bolting (Year 2) plants before they set seed; POST herbicides, early spring control",
  ...
  },
  {
    ...
    safetyNote:
      "HIGHLY POISONOUS — tropane alkaloids (atropine, scopolamine) can cause hallucinations, rapid heartbeat, seizures, and death in humans and animals if ingested. Contact with the sap can cause skin irritation or pupil dilation if you touch your eyes after handling the plant.",
  },
  {
    id: "Eastern_Black_Nightshade",
    ...
    actImmediately: false,
    actReason:
      "Moderate competitor; toxicity level lower than Jimsonweed but still present. Group 2 herbicide resistance documented; berries contaminate and stain harvested crop.",
  ...
  },
  {
    ...
    lookAlike: {
      ...
      species: "Waterhemp",
      difference:
        "Palmer amaranth usually has longer petioles than the leaf blade, while waterhemp has shorter petioles; Palmer also has spiny bracts/seed head, while waterhemp lacks those spines.",
    },
    memoryHook: "Palmer grows like a palm tree — fast and tall",
    safetyNote:
      "Can accumulate high nitrates and sometimes oxalates; heavy consumption by ruminants can lead to nitrate poisoning.",
  },
  {
    id: "Redroot_Pigweed",
    ...
    lookAlike: {
      ...
      species: "Palmer Amaranth",
      difference:
        "Palmer has longer petioles and is less hairy; Redroot has red taproot. Redroot pigweed is monoecious (both male and female flowers on same plant), unlike waterhemp and Palmer amaranth which are dioecious",
    },
  ...
  },
  {
    ...
    lookAlike: {
      ...
      difference:
        "Yellow rocket often has deeper lobing in basal leaves and long upright siliques, while many wild mustards have more obviously hairy/bristly leaves and stems and different pod shape/attachment.",
    },
  ...
  },
  {
    ...
    actImmediately: false,
    actReason:
      "Winter annual responsive to fall/spring herbicides; moderate competitive threat; a single plant can produce up to 40,000 seeds",
  ...
  },
  {
    ...
    actImmediately: true,
    actReason:
      "Highly competitive; develops herbicide resistance; produces 40,000 to over 100,000 seeds making it highly prolific; prefers compacted soils",
  ...
  },
  {
    ...
    lookAlike: {
      ...
      species: "Curly Dock",
      difference:
        "Dock leaves are wavy to curly but not spiny-burred; burdock has coarse, wavy-margined leaves and spiny burr seed heads",
    },
  ...
  },
  {
    ...
    controlTiming:
      "Apply during active growth when seedling is small; repeat applications needed to deplete root reserves",
    lookAlike: {
      id: "Tall_morningglory",
      species: "Tall Morningglory",
  ...
  },
  {
    ...
    lookAlike: {
      ...
      difference: "Cocklebur has spiny bur fruits and lobed leaves; Sunflower has large flower heads and simple leaves",
    },
  ...
  },
  {
    ...
    lookAlike: {
      ...
      species: "Goosegrass",
      difference:
        "Goosegrass has flat stems and zipper seedheads; Yellow Nutsedge has triangular stems — sedges have edges",
    },
    memoryHook:
