...
export const weeds: Weed[] = [
...

  {
    ...
    traits: [
      "Upright hairy stems with narrow, unevenly lobed leaves",
...

  {
    ...
    traits: [
      "Completely hairless (smooth) stems and leaves — no fuzz anywhere on the plant",
      "Long, narrow, glossy leaves shaped like a willow leaf, with a short leaf stem (petiole) that is always shorter than the leaf blade",
      "Slender, soft, branching flower spikes at the top of the plant — no stiff, prickly bracts to poke your hand",
...

  {
    ...
    traits: [
      ...
      "Upright growth (1–2 feet) in spring",
...

  {
    ...
    traits: [
      ...
      "Upright, hollow stems reaching up to 5 feet high",
    ],
