...
export const weeds: Weed[] = [
	{
		...
		traits	[
			...
			"Grows 6–8 feet tall with prolific seed production",
		],
		habitat	"Waterhemp prefers poorly drained soils, though sources note it can tolerate a wide range of conditions.",
	...
	},
	{
		...
		traits	[
			...
			"Female Palmer amaranth has large bracts that are green, up to ¼ inch in length, and extend well beyond the tepals and seed capsule",
		...
		lookAlike	{
			id	"Waterhemp",
			species	"Waterhemp",
			difference	"Palmer amaranth usually has longer petioles than the leaf blade, while waterhemp has shorter petioles; Palmer also has spiny bracts/seed head, while waterhemp lacks those spines.",
		},
		memoryHook	"Palmer grows like a palm tree — fast and tall",
		safetyNote	"Can accumulate high nitrates and sometimes oxalates; heavy consumption by ruminants can lead to nitrate poisoning.",
	},
	{
		id	"Redroot_Pigweed",
		...
		primaryHabitat	"Warm-Season / Full Sun",
		actImmediately	true,
		actReason	"Prolific seed producer and competitive weed in disturbed sites and crops",
		management	"PRE herbicides, early POST before 4 inches, cultivation",
		controlTiming	"Seedling to 4-inch stage",
		lookAlike	{
			id	"Palmer_Amaranth",
			species	"Palmer Amaranth",
			difference	"Palmer has longer petioles and is less hairy; Redroot has red taproot. Redroot pigweed is monoecious (both male and female flowers on same plant), unlike waterhemp and Palmer amaranth which are dioecious",
		},
	...
	},
	{
		...
		traits	[
			...
			"Glossy dark green basal leaves, especially in the rosette stage",
		],
		...
		lookAlike	{
			...
			difference	"Yellow rocket often has deeper lobing in basal leaves and long upright siliques, while many wild mustards have more obviously hairy/bristly leaves and stems and different pod shape/attachment.",
		},
	...
	},
	{
		...
		primaryHabitat	"Cool-Season / Early Spring",
		actImmediately	true,
		actReason	"Competitive in small grains; single plant produces 3000+ seeds",
	...
	},
	{
		...
		habitat	"Gardens, disturbed areas, field margins, roadsides, and lawns",
		primaryHabitat	"Cool-Season / Early Spring",
		actImmediately	false,
		actReason	"Winter annual responsive to fall/spring herbicides; moderate competitive threat; a single plant can produce up to 40,000 seeds",
	...
	},
	{
		...
		traits	[
			...
			"The base of the upper leaves has pointed, arrow-shaped lobes (auricles) that clasp the stem",
			"Leaves and stems emit a strong, garlicky or turnip-like odor when crushed",
		],
		habitat	"Small grain fields, disturbed areas",
		primaryHabitat	"Cool-Season / Early Spring",
		actImmediately	true,
		actReason	"ALS-inhibitor resistance documented; prolific seed producer",
	...
	},
 	{
		...
		traits	[
			...
			"Small white four-petaled flowers",
			"Year 2: Rapid \"bolting\" in spring to produce a tall stem (2-4 feet) with heart-shaped, sharply toothed leaves.",
			"Long slender seed pods",
		],
		habitat	"Woodlands, disturbed areas, shade tolerant",
		primaryHabitat	"Cool-Season / Early Spring",
		actImmediately	true,
		actReason	"Reported allelopathic effects; displaces native understory flora; disrupts mycorrhizal networks.",
		management	"Hand pulling is most effective on bolting (Year 2) plants before they set seed; POST herbicides, early spring control",
	...
	},
	{
		...
		primaryHabitat	"Cool-Season / Early Spring",
		actImmediately	false,
		actReason	"Perennial with deep taproot; prolific wind-dispersed seed producer; difficult to fully eradicate",
	...
	},
	{
		...
		safetyNote	"Can cause skin and respiratory irritation in sensitive people and may be mildly toxic to livestock if grazed heavily.",
	},
	{
		id	"Prickly_Lettuce",
		...
		primaryHabitat	"Warm-Season / Full Sun",
		actImmediately	false,
		actReason	"Moderate competitor; cattle toxicity documented, herbicide resistance",
	...
	},
	{
		...
		safetyNote	"HIGHLY POISONOUS — tropane alkaloids (atropine, scopolamine) can cause hallucinations, rapid heartbeat, seizures, and death in humans and animals if ingested. Contact with the sap can cause skin irritation or pupil dilation if you touch your eyes after handling the plant.",
	},
	{
		id	"Eastern_Black_Nightshade",
		commonName	"Eastern Black Nightshade",
		scientificName	"Solanum ptycanthum",
		eppoCode	"SOLPT",
		family	"Solanaceae",
		plantType	"Dicot",
		lifeCycle	"Annual",
		...
		traits	[
			...
			"Undersides of the leaves are often a deep purple color",
		],
		habitat	"Disturbed areas, gardens, field margins",
		primaryHabitat	"Dry / Disturbed",
		actImmediately	false,
		actReason	"Moderate competitor; toxicity level lower than Jimsonweed but still present. Group 2 herbicide resistance documented; berries contaminate and stain harvested crop.",
		...
		safetyNote	"Contains toxic alkaloids in leaves and unripe berries; ingestion can cause gastrointestinal and neurological signs in people and livestock.",
	},
 	{
		id	"Horsenettle",
		...
		traits	[
			...
			"Orange-yellow berries at maturity. Berries are smooth and exposed, not enclosed in a prickly husk",
		...
		safetyNote	"A spiny nightshade with toxic glycoalkaloids in fruit and foliage; ingestion can cause digestive upset and neurological signs in livestock and people.",
	},
	{
		id	"Buffalobur",
		...
		safetyNote	"Spiny plant whose berries and foliage contain solanine-type alkaloids that are poisonous to livestock and humans if eaten.",
	},
	{
		id	"Smooth_Groundcherry",
		commonName	"Smooth Groundcherry",
		scientificName	"Physalis longifolia var. subglabrata",
		eppoCode	"PHYSB",
		family	"Solanaceae",
		plantType	"Dicot",
		lifeCycle	"Perennial",
		...
		safetyNote	"Unripe (green) berries and the foliage contain solanine, which is toxic to humans and livestock if ingested.",
	},
	{
		id	"Tallmorningglory",
		...
		primaryHabitat	"Warm-Season / Full Sun",
		actImmediately	true,
		actReason	"Highly competitive; twines around crops; allelopathic; prolific seed production",
		...
		safetyNote	"Seeds contain compounds that can cause digestive upset and in large doses neurological signs in livestock.",
	},
	{
		id	"Fieldbindweed",
		...
		traits	[
			...
			"Prostrate trailing growth when no support present",
		],
		habitat	"Pastures, roadsides, field margins, disturbed areas",
		primaryHabitat	"Dry / Disturbed",
		actImmediately	true,
		actReason	"Perennial spreads via rhizomes; extremely difficult to control; long-lived seeds (50+ years)",
		...
		lookAlike	{
			...
			difference	"Field Bindweed has two tiny, scale-like bracts located on the flower stem about 1/2 to 1 inch below the flower. (In Hedge Bindweed, the bracts are large and right at the base of the flower)",
		},
	...
	},
	{
		...
		primaryHabitat	"Warm-Season / Full Sun",
		actImmediately	true,
		actReason	"Competes vigorously; difficult to control once vined; seeds persist 20+ years",
	...
	},
	{
		...
		traits	[
			...
			"Ocrea—a thin, paper-like sheath that wraps around the stem at each node (where the leaf meets the stem)",
		],
	...
	},
	{
		...
		traits	[
			...
			"Produces 2,000–7,500 seeds per plant",
		],
		...
		controlTiming	"Before 4-leaf stage; post-emergence control becomes ineffective quickly",
		lookAlike	{
	...
	},
	{
		...
		traits	[
			...
			"Hairy ligule",
			"Stems (culms) often develop a \"zig-zag\" growth habit at the nodes",
	...
	},
	{
		...
		management	"POST grass herbicides late season, improved crop vigor at boot stage during active growth",
	...
	},
	{
		...
		management	"PRE herbicides, early POST before boot, improved species reseeding, mechanical control (tillage) is particularly effective given the shallow root system",
		...
		safetyNote	"Seed heads form sharp awns that can lodge in the mouths, eyes, and skin of pets and livestock, causing painful injuries, infections, and abscesses.",
	},
	{
		id	"Quackgrass",
		...
		management	"Repeated POST glyphosate, mechanical removal of rhizomes, rotation, fall applications are significantly more effective",
	...
	},
	{
		...
		traits	[
			...
			"As it matures and dries in late spring, it turns a very distinct purplish-red before fading to a straw-yellow",
			"12–20 inches tall",
		...
		primaryHabitat	"Cool-Season / Early Spring",
		actImmediately	false,
		actReason	"Fire risk; winter annual; early season growth; late spring control difficult",
		management	"Fall POST herbicides, early spring control, reseeding, prescribed burning, crop rotation is the most effective control method. Crops planted in late spring such as corn, grain sorghum, proso millet, and sunflower are much more effective for long-term management.",
 ...
 commonName: "Shattercane/Sorghums",
  scientificName: "Sorghum x drummondii",
  eppoCode: "SORSU",
  family: "Poaceae",
  plantType: "Monocot",
 ...
 primaryHabitat: "Warm-Season / Full Sun",
 actImmediately: true,
 actReason: "Cross-breeding with cultivated sorghum; allelopathic; produces 5,000+ seeds",
 ...
 primaryHabitat: "Dry / Disturbed",
 actImmediately: true,
 actReason: "Highly competitive; develops herbicide resistance; produces 40,000 to over 100,000 seeds making it highly prolific; prefers compacted soils",
 ...
 controlTiming: "2-4 leaf stage; becomes difficult past 6 leaves",
  ...
  difference: "Shares a similar growth habit and seedhead structure, but can be distinguished by goosegrass's flat stems and larger inflorescences",
  },
 ...
 species: "Redroot Pigweed",
  difference: "Pigweed has red taproot; Copperleaf has green ovate leaves",
  },
 ...
 habitat: "Warm-season row crops, disturbed areas, moist soils",
  ...
  management: "PRE herbicides, early POST, hand removal, mechanical cultivation, mulching, preventive sanitation",
 ...
 plantType: "Dicot",
  ...
  "Vigorous vining growth (15–25 feet)",
 ...
 safetyNote: " Can cause low-level poisoning if eaten in quantity by livestock and may inflame the digestive tract; bristly stems can irritate sensitive skin.",
 },
 {
 ...
 "Red/purple tubular flowers in whorls",
  "Clasping upper leaves; upper leaves lack petioles and attach directly to the stem",
  "6–12 inches tall",
 ],
 ...
 "Rhizomatous spreading",
  ...
  habitat: "Field margins, pastures, disturbed areas, roadsides, natural areas",
 primaryHabitat: "Dry / Disturbed",
 actImmediately: true,
 ...
 safetyNote: " Contains cardiac glycosides similar to oleander; highly toxic to livestock and pets if ingested, leading to heart and digestive problems.",
 },
 {
 id: "common_Milkweed",
 ...
 habitat: "Pastures, roadsides, field margins, disturbed areas",
  ...
  controlTiming: "Seedling stage or fall regrowth",
 lookAlike: {
 id: "Hemp_dogbane",
 ...
 safetyNote: " Contains cardiac glycosides that can poison livestock and pets if ingested, causing digestive upset, weakness, and potentially heart problems.",
 },
 {
 ...
 safetyNote: " Milkweed relative with cardiac glycosides; ingestion can cause vomiting, diarrhea, and heart rhythm disturbances in animals.",
 },
 {
 id: "CommonChickweed",
 ...
 management: "POST broadleaf herbicides fall or spring, tillage",
 ...
 "Mat-forming, typically 2–6 inches tall",
 ...
 id: "Curly_dock",
 species: "Curly Dock",
 difference: "Dock leaves are wavy to curly but not spiny-burred; burdock has coarse, wavy-margined leaves and spiny burr seed heads",
 },
 ...
 primaryHabitat: "Cool-Season / Early Spring",
 actImmediately: false,
 actReason: "Bulb perennial with aggressive offsets; poor herbicide response; removal is difficult because small bulbs are easily missed",
 ...
 id: "Wild_Carrot",
 species: "Wild Carrot",
 difference: "Carrot has flat-topped white flowers; Star has upright star-shaped flowers",
 },
 memoryHook: "Star of Bethlehem = white star flowers with green stripe + bulbous + grass-like leaves",
 safetyNote: " Ornamental bulb that is poisonous; cardiac glycosides in bulbs and leaves can cause vomiting, arrhythmias, and potentially death if ingested.",
 },
 {
 id: "Russian_thistle",
 ...
 id: "kochia",
 species: "Kochia",
 difference: "Kochia has softer, flat leaves and does not develop spines; Russian Thistle becomes spiny at maturity",
 },
 ...
 controlTiming: "Apply during active growth when seedling is small; repeat applications needed to deplete root reserves",
 lookAlike: {
 id: "Tall_morningglory",
 species: "Tall Morningglory",
 ...
 traits: [
 "Finely pinnately divided, alternate leaves, often glandular-hairy on surfaces and stems",
 "Small yellow four-petaled flowers",
 "Erect strict growth (0.5–2 feet)",
 ...
 "Fertile stems (brown, unbranched, early spring, with cone) and Vegetative stems (green, branched)",
 "1–2 feet tall",
 ],
 ...
 safetyNote: " Contains thiaminase that destroys vitamin B1; chronic ingestion by horses and livestock can cause weakness, weight loss, and neurologic signs.",
 },
 {
 id: "Scouringrush",
 ...
 safetyNote: " Like other horsetails, contains thiaminase that can cause vitamin B1 deficiency and neurologic signs in grazing animals when eaten chronically.",
 },
 {
 id: "commonPokeweed",
 ...
 safetyNote: " All parts, especially roots and berries, contain pokeweed toxins; ingestion can cause severe gastrointestinal irritation and systemic illness in humans and animals.",
 },
 {
 id: "Wild_Carrot",
 ...
 "White/cream-colored taproot (edible but small)",
 ...
 safetyNote: " Foliage can cause skin irritation in sensitive people; often confused with deadly look-alikes such as poison hemlock and water hemlock.",
 },
 {
 id: "Corn_speedwell",
 ...
 id: "CommonChickweed",
 species: "Common Chickweed",
 difference: "Chickweed has opposite hairy leaves; Speedwell has smaller leaves with hairy leaves and round stems",
 },
 ...
 difference: "Venice mallow: upright, yellow flowers with dark eye, lobed leaves; common mallow: trailing, small pink/white flowers, round scalloped leaves",
 },
 ...
 safetyNote: " Milky sap is irritating to skin and mucous membranes; ingestion by pets or livestock can cause vomiting and diarrhea.",
 },
 {
 id: "Toothed_spurge",
 ...
 safetyNote: " Closely related to spotted spurge; acrid latex sap can irritate skin and eyes and cause gastrointestinal upset if consumed.",
 },
 {
 id: "annual-ryegrass",
 ...
 lookAlike: { id: "Quackgrass", species: "Quackgrass", difference: "Quackgrass has rhizomes and rough upper leaf surface; Ryegrass is bunch-type with glossy leaves" },
 ...
 lookAlike: { id: "large-crabgrass", species: "Large Crabgrass", difference: "Crabgrass has a ligule and finger-like seedheads; Barnyardgrass has no ligule and panicle seedhead" },
 memoryHook: "Barnyardgrass = NO ligule (unique among grasses) + purplish stems + wet areas",
 },
 {
 id: "canada-thistle",
 ...
 lookAlike: { id: "Musk_thistle", species: "Musk Thistle", difference: "Musk thistle has large nodding flower heads and winged spiny stems; Canada thistle has small clustered flowers" },
 memoryHook: "Canada thistle = small purple flowers in clusters + creeping roots = colonial invader",
 },
 {
 id: "caraway",
 commonName: "Caraway",
 ...
 lookAlike: { id: "Wild_Carrot", species: "Wild Carrot", difference: "Wild Carrot has hairy stems and a flat-topped umbel with a dark center floret; Caraway is smooth with aromatic seeds" },
 ...
 lookAlike: { id: "giant-ragweed", species: "Giant Ragweed", difference: "Giant ragweed has 3-5 lobed palmate leaves and grows much taller (up to 15 ft); Common ragweed has finely dissected fern-like leaves" },
 ...
 origin: "Introduced",
 emoji: "",
 traits: ["Nodding seedhead", "Hairy upper leaf surface", "Large drooping panicle", "Tall growth"],
 habitat: "Crop fields, gardens, roadsides, disturbed areas",
 primaryHabitat: "Warm-Season / Full Sun",
 management: "Pre-emergent herbicides; post-emergent grass herbicides",
 controlTiming: "Before 3-leaf stage; early season",
 actImmediately: false,
 actReason: "One of the most competitive annual grass weeds in Midwest row crops",
 lookAlike: { id: "green-foxtail", species: "Green Foxtail", difference: "Green foxtail has upright seedheads and smooth leaves; Giant foxtail has nodding heads and hairy upper leaf surfaces" },
 memoryHook: "Giant foxtail = NODDING fuzzy seedhead + hairy leaves + tallest foxtail",
 },
 {
 id: "giant-ragweed",
 ...
 origin: "Native",
 emoji: "",
 traits: ["3-5 lobed palmate leaves", "Very tall growth", "Rough stems", "Green flower spikes"],
 habitat: "Floodplains, crop fields, roadsides, rich soils",
 primaryHabitat: "Warm-Season / Full Sun",
 management: "Pre-emergent herbicides; post-emergent before 12-inch height",
 controlTiming: "Before 6-inch height; grows extremely fast",
 actImmediately: true,
 actReason: "Can grow 15+ feet tall; extremely competitive; herbicide resistance increasing",
 lookAlike: { id: "common-ragweed", species: "Common Ragweed", difference: "Common ragweed has finely dissected fern-like leaves; Giant ragweed has large 3-5 lobed palmate leaves" },
 ...
 lookAlike: { id: "wild-parsnip", species: "Wild Parsnip", difference: "Wild parsnip has grooved stems and causes phytophotodermatitis burns; Golden Alexanders has smooth stems and is non-toxic" },
 memoryHook: "Golden Alexanders = yellow umbels + smooth stems + SAFE native (vs. toxic parsnip)",
 },
 {
 id: "green-foxtail",
 ...
 origin: "Introduced",
 emoji: "",
 traits: ["Upright seedhead", "Smooth leaves", "Green bristly panicle", "Shorter than giant foxtail"],
 habitat: "Crop fields, gardens, roadsides, waste areas",
 primaryHabitat: "Warm-Season / Full Sun",
 management: "Pre-emergent herbicides; post-emergent grass herbicides early",
 controlTiming: "Before 3-leaf stage",
 actImmediately: false,
 actReason: "Common annual grass weed but less competitive than giant foxtail",
 lookAlike: { id: "yellow-foxtail", species: "Yellow Foxtail", difference: "Yellow foxtail has long hairs at the leaf collar and yellowish seedheads; Green foxtail has green bristles and no collar hairs" },
 memoryHook: "Green foxtail = upright GREEN bristly seedhead + smooth leaves + no collar hairs",
 },
 {
 id: "johnsongrass",
 ...
 origin: "Introduced",
 emoji: "",
 traits: ["White midrib", "Large open panicle", "Rhizomatous", "Tall growth to 8 ft"],
 ...
 lookAlike: { id: "Shattercane_Sorghums", species: "Shattercane/Sorghums", difference: "Shattercane lacks rhizomes and is annual; Johnsongrass has extensive rhizomes and is perennial" },
 ...
 safetyNote: " Can accumulate nitrates and other toxins that cause poisoning, photosensitization, and liver damage in grazing animals when eaten in large amounts.",
 },
 {
 id: "lambsquarters",
 ...
 lookAlike: { id: "kochia", species: "Kochia", difference: "Kochia has narrow lance-shaped leaves and pyramidal form; Lambsquarters has diamond-shaped leaves with white mealy coating" },
 memoryHook: "Lambsquarters = white powdery/mealy leaf coating + diamond-shaped leaves + goosefoot family",
 },
 {
 id: "large-crabgrass",
 ...
 origin: "Introduced",
 emoji: "",
 traits: ["Finger-like seedheads", "Hairy leaves and sheaths", "Prostrate to ascending", "Roots at nodes"],
 habitat: "Lawns, gardens, crop fields, disturbed areas",
 primaryHabitat: "Warm-Season / Full Sun",
 management: "Pre-emergent herbicides in spring; post-emergent when small",
 controlTiming: "Pre-emergent timing critical; post-emergent before tillering",
 actImmediately: false,
 actReason: "Most common lawn weed grass; fills thin turf areas aggressively",
 lookAlike: { id: "Goosegrass", species: "Goosegrass", difference: "Goosegrass has a white/silver center and zipper-like seedheads; Crabgrass has finger-like spreading seedheads" },
 memoryHook: "Large crabgrass = finger-like seedheads + hairy + roots at nodes + lawn nemesis",
 },
 {
 id: "marestail",
 ...
 origin: "Native",
 emoji: "",
 traits: ["Unbranched stem", "Narrow crowded leaves", "Small white flowers", "Fall or spring germination"],
 habitat: "No-till fields, roadsides, disturbed areas",
 primaryHabitat: "Dry / Disturbed",
 management: "Pre-emergent herbicides; burndown with multiple modes of action",
 ...
 lookAlike: { id: "Horseweed", species: "Horseweed", difference: "Marestail and Horseweed are the same species with regional name differences" },
 memoryHook: "Marestail = tall unbranched wiry stem + glyphosate-resistant poster child + no-till problem",
 },
 {
 id: "morningglory",
 ...
 safetyNote: " Seeds and foliage can cause digestive disturbances and possible neurologic effects when consumed in quantity by animals.",
 },
 {
 ...
 origin: "Native",
 emoji: "",
 traits: ["Swollen nodes", "Ocrea (sheath)", "Pink flower spikes", "Lance-shaped leaves"],
 habitat: "Crop fields, wet areas, gardens, disturbed moist soils",
 primaryHabitat: "Wet / Poorly Drained",
 management: "Pre-emergent and post-emergent broadleaf herbicides; drainage improvement",
 controlTiming: "Seedling to 4-inch stage",
 actImmediately: false,
 actReason: "Common in wet field areas; indicator of poor drainage",
 lookAlike: { id: "Ladysthumb", species: "Lady's Thumb", difference: "Lady's Thumb has a dark chevron/thumbprint mark on leaves; Pennsylvania Smartweed lacks the leaf mark" },
 memoryHook: "Pennsylvania smartweed = pink spikes + NO thumbprint on leaf + wet areas + swollen nodes",
 },
 {
 id: "poison-hemlock",
 ...
 lookAlike: { id: "Wild_Carrot", species: "Wild Carrot", difference: "Wild Carrot has hairy stems and a dark center floret; Poison Hemlock has smooth purple-spotted stems and musty odor" },
 memoryHook: "Poison hemlock = PURPLE SPOTS on smooth hollow stems + DEADLY toxic + musty smell",
 safetyNote: " EXTREMELY TOXIC — all parts of the plant are poisonous. Can cause death in humans and livestock. Do NOT touch without gloves. Wash hands immediately if contact occurs.",
 },
 {
 id: "velvetleaf",
 ...
 origin: "Introduced",
 emoji: "",
 traits: ["Large heart-shaped velvety leaves", "Yellow flowers", "Cup-shaped seed pods", "Tall growth"],
 habitat: "Crop fields, gardens, disturbed rich soils",
 primaryHabitat: "Warm-Season / Full Sun",
 management: "Pre-emergent herbicides; post-emergent broadleaf herbicides",
 controlTiming: "Before 4-leaf stage; seedlings most susceptible",
 actImmediately: false,
 actReason: "Highly competitive in corn and soybeans; long-lived seed bank",
 lookAlike: { id: "Common_Mallow", species: "Common Mallow", difference: "Common Mallow has round scalloped leaves close to ground; Velvetleaf has large soft heart-shaped leaves and grows tall" },
 memoryHook: "Velvetleaf = soft velvety heart leaves + yellow flowers + distinctive cup-shaped seed pods",
 },
 {
 ...
 origin: "Native",
 emoji: "",
 traits: ["Large rough leaves", "Yellow ray flowers", "Tall thick stems", "Alternate leaves"],
 habitat: "Crop fields, roadsides, gardens, disturbed areas",
 primaryHabitat: "Warm-Season / Full Sun",
 management: "Post-emergent broadleaf herbicides; cultivation; roguing",
 controlTiming: "Before 6-inch height; before competition with crop",
 actImmediately: false,
 actReason: "Competitive volunteer from previous crops or bird seed; shades out crops",
 lookAlike: { id: "common_Cocklebur", species: "Common Cocklebur", difference: "Cocklebur has spiny bur fruits and lobed leaves; Sunflower has large flower heads and simple leaves" },
 ...
 origin: "Introduced",
 emoji: "",
 traits: ["Twisted bent awns", "Open panicle", "Hairy lemma", "Clasping auricles"],
 ...
 lookAlike: { id: "annual-ryegrass", species: "Annual Ryegrass", difference: "Ryegrass has spike-type seedheads; Wild Oat has open panicle with distinctive twisted awns" },
 memoryHook: "Wild oat = twisted bent awns + open drooping panicle + small grain pest",
 },
 {
 id: "wild-parsnip",
 ...
 lookAlike: { id: "golden-alexanders", species: "Golden Alexanders", difference: "Golden Alexanders has smooth stems and is non-toxic; Wild Parsnip has grooved stems and causes burns" },
 memoryHook: "Wild parsnip = yellow umbels + grooved stems + CAUSES BURNS in sunlight + biennial",
 safetyNote: " PHYTOPHOTODERMATITIS RISK — Plant sap causes severe blistering burns when skin is exposed to sunlight. Wear long sleeves, gloves, and eye protection. Do NOT mow on sunny days.",
 },
 {
 id: "yellow-foxtail",
 ...
 origin: "Introduced",
 emoji: "",
 traits: ["Long hairs at leaf collar", "Yellowish compact seedhead", "Twisted leaves", "Short growth"],
 habitat: "Crop fields, lawns, gardens, roadsides",
 primaryHabitat: "Warm-Season / Full Sun",
 management: "Pre-emergent herbicides; post-emergent grass herbicides",
 controlTiming: "Before 3-leaf stage",
 actImmediately: false,
 actReason: "Common annual grass weed in row crops and turf",
 lookAlike: { id: "green-foxtail", species: "Green Foxtail", difference: "Green foxtail has no collar hairs and green bristles; Yellow foxtail has distinctive long hairs at leaf collar" },
 ...
 lookAlike: { id: "Goosegrass", species: "Goosegrass", difference: "Goosegrass has flat stems and zipper seedheads; Yellow Nutsedge has triangular stems — sedges have edges" },
 memoryHook: "Yellow nutsedge = triangular stem (sedges have edges!) + underground tubers + grass-like but NOT a grass",
 },
 {
 id: "White_campion",
 ...
 lookAlike: { id: "CommonChickweed", species: "Common Chickweed", difference: "Chickweed is prostrate with tiny flowers; White Campion is upright with large 5-petaled white flowers and inflated calyx" },
 memoryHook: "White campion = large white flowers + inflated balloon-like calyx + sticky hairy stems",
 },
 {
 id: "Marijuana",
 ...
 lookAlike: { id: "Hemp_dogbane", species: "Hemp Dogbane", difference: "Hemp Dogbane has simple opposite leaves with milky sap; Marijuana has palmate compound leaves with no milky sap" },
 memoryHook: "Marijuana/Wild hemp = palmate 5-7 leaflets + distinctive odor + feral Midwest populations",
 safetyNote: " Cannabis sativa is a regulated/controlled plant in most U.S. jurisdictions. Wild/feral hemp is common in the Midwest from historical cultivation. Always follow local laws.",
 },
];
